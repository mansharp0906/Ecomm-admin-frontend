...
const validationSchema = Yup.object({
  name: Yup.string()
    ...
    .max(50, 'Sub Category name must be less than 50 characters'),
  slug: Yup.string()
    .matches(
      /^[a-z0-9-]+$/,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.data?.success) {
        console.log('Sub Category Created Response:', response.data);
        console.log('Created Sub Category:', response.data.data);
