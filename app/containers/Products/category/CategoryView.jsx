          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{category.slug || 'N/A'}</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700">Description</label>
                <p className="mt-1 text-sm text-gray-900">{category.description || 'N/A'}</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{category.priority || 'N/A'}</p>
              </div>
            </div>

            {/* Status & Media */}
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-900">Status & Media</h3>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-900">{category.metaTitle || 'N/A'}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Meta Description</label>
                <p className="mt-1 text-sm text-gray-900">{category.metaDescription || 'N/A'}</p>
              </div>
            </div>
          </div>
